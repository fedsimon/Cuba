...
public class CodigoDater {
    ...
    public static void iteratorOverAllFiles(File[] files){
        for (File file : files) {
            ...
            if (file.isDirectory() && !file.getName().equals("casas") && !file.getName().contains("REV")) {
    ...
    public static void writeTheHashtableToTextFile () throws IOException{
        ...
        File theAllTXTFile = new File (onMac + "DateDictionary.csv");
        ...
        try {allFileWriter.close();} catch (IOException e) {}
